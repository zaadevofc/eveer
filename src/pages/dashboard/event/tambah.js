...
const Tambah = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios({
            ...
            if (res.data?.id) {
                Swal.fire('Berhasil', 'Event berhasil ditambahkan!', 'success').then((res) => {
    ...
    return (
        <>
            ...
            <Template header='Tambah Event' breadCrumb={[{ label: 'Dashboard', link: '/dashboard' }, { label: 'Event', link: '/dashboard/event' }, { label: 'Tambah Event', link: '/dashboard/event/tambah' }]} breadCrumbRightContent={
                    ...
                    <div className="card">
                        <div className="card-body">
                            ...
                            <div className="mb-3">
                                ...
                                <input type='file' className={`form-control ${gambarError !== '' ? 'is-invalid' : ''}`} id='gambar' onChange={(e) => setGambar(e.target.files[0])} required />
                                {gambarError !== '' && (
