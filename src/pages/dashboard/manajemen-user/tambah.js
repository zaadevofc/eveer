...
const Tambah = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios({
            method: 'PATCH',
            url: `${process.env.NEXT_PUBLIC_RESTFUL_API != undefined ? process.env.NEXT_PUBLIC_RESTFUL_API : ''}/account`,
            data: {
                namaLengkap,
                email,
                password,
            ...
            if (res.data?.id) {
                Swal.fire('Berhasil', 'User berhasil ditambahkan!', 'success').then((res) => {
    ...
    return (
        <>
            ...
            <Template header='Tambah User' breadCrumb={[{ label: 'Dashboard', link: '/dashboard' }, { label: 'User', link: '/dashboard/manajemen-user' }, { label: 'Tambah User', link: '/dashboard/manajemen-user/tambah' }]} breadCrumbRightContent={
                <Link href='/dashboard/manajemen-user' className='btn btn-secondary rounded-xl'>
                    ...
                    <div className="card">
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-3">
                                    <label htmlFor="password" className="mb-1">Kata Sandi <span className="text-danger">*</span></label>
