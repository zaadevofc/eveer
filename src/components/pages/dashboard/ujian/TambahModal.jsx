...
const TambahModal = ({ modalRef, getData }) => {
    ...
    const [mataPelajaranKelasId, setMataPelajaranKelasId] = useState('')
    ...
    const handleSubmit = async (e) => {
        ...
        await axios({
            method: 'PUT',
            url: `${process.env.NEXT_PUBLIC_RESTFUL_API != undefined ? process.env.NEXT_PUBLIC_RESTFUL_API : ''}/ujian`,
            data: {
                nama,
            ...
            if (res.data?.id) {
                ...
                setNama('')
                setNamaError('')
                setMataPelajaranKelasId('')
                setMataPelajaranKelasIdError('')
                setIsWaktuPengerjaan('')
